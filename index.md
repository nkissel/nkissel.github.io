...
Currently, I am working on a model selection paper with [Lucas Mentch](http://lucasmentch.com/index.html) and also completing my advanced data analysis project on crater detection under the supervision [Max G'Sell](http://stat.cmu.edu/people/faculty/mgsell). Additionally, I am a member of the Study Design and Analysis in Psychiatry group in the Pyschiatry Department at Pitt.
